...
const projectData = [
  {
    ...
    githubBackend:
      "https://github.com/RudraPrakash-m/TaskManagerBackend-backend",
  },
  {
    ...
    features: [
      "MongoDB Educational Content",
      "**MailJS Contact Form Integration**",
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p
            ...
            variants={fadeInUp}
          >
            A showcase of my full-stack development skills, ranging from core
            web technologies to complex MERN applications with modern API
            integrations.
          </motion.p>
        </motion.header>
        ...
        {/* Projects */}
        <ProjectCard data={{staggerContainer, projectData, cardHover, fadeInUp}}/>
        ...
        >
          <p>
            This portfolio showcases versatility, covering everything from core
            web development to complex full-stack applications and API
            integrations.
          </p>
        </motion.div>
      </div>
